...
| `CtaCenter`          | `page-sections/ctas/cta-center`            |
| `CtaSplit`           | `page-sections/ctas/cta-split`             |
| `CtaForm`            | `page-sections/ctas/cta-form`              |
| `FeatureGrid`        | `page-sections/features/feature-grid`      |
| `FeatureSplit`       | `page-sections/features/feature-split`     |
| `FeatureSlider`      | `page-sections/features/feature-slider`    |
| `FaqSection`         | `page-sections/info-blocks/faq-section`    |
| `TeamGrid`           | `page-sections/people/team-grid`           |
| `TestimonialSection` | `page-sections/people/testimonial-section` |
