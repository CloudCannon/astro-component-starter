...
| `video`           | Video component for YouTube, Vimeo, and HTML5 sources.            | `type` (`youtube`/`vimeo`/`local-source`), `title`, `videoId`, `source`, `thumbnail`                                                                                                                                                                                                                                |
