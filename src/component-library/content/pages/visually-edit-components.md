...
Here's [CTA Center](/component-library/components/page-sections/ctas/cta-center/) as a real-world example using all three patterns:
...
If you'd rather not wire these up by hand, the [Component Builder](/component-library/component-builder/) handles all the editable regions for you. It generates the right `data-*` attributes on every building block it includes, so the exported component is fully editable out of the box.

## Next up

You've completed the Getting Started guide. You can build components, brand them, and make them visually editable. From here, explore the full set of components in the sidebar — each one documents its props, examples, and CloudCannon configuration. Or head to the [Component Builder](/component-library/component-builder/) to prototype new sections visually.
